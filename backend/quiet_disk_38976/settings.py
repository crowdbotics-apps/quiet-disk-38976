"""
Django settings for quiet_disk_38976 project.
...
ROOT_URLCONF = 'quiet_disk_38976.urls'
...
WSGI_APPLICATION = 'quiet_disk_38976.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "quiet_disk_38976 API",
    "DESCRIPTION": "API documentation for quiet_disk_38976 App",
    "VERSION": "v1",
}
